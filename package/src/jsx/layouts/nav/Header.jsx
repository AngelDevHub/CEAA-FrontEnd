                           ...
                           <ul className="timeline">
                              ...
                              <li>
                                 <div className="timeline-panel">
                                    ...
                                    <div className="media-body">
                                       <h6 className="mb-1">Temperatura alta detectada 🌡️</h6>
                                       <small className="d-block">
                                          Invernadero 1 — 07 Oct 2025 - 08:15 AM
                                       </small>
                                       <small className="text-danger">Valor: 33.4°C</small>
                                    </div>
                                 </div>
                              </li>

                              {/* 💧 Notificación de humedad baja */}
                              <li>
                                 <div className="timeline-panel">
                                    <div className="media me-2 media-warning">
                                       <i className="fa fa-tint" />
                                    </div>
                                    <div className="media-body">
                                       <h6 className="mb-1">Humedad baja detectada 💧</h6>
                                       <small className="d-block">
                                          Parcela 2 — 07 Oct 2025 - 08:10 AM
                                       </small>
                                       <small className="text-warning">Valor: 42%</small>
                                    </div>
                                 </div>
                              </li>

                              {/* ⚗️ Nivel de nitrógeno bajo */}
                              <li>
                                 <div className="timeline-panel">
                                    ...
                                    <div className="media-body">
                                       <h6 className="mb-1">Nivel de nitrógeno bajo ⚗️</h6>
                                       <small className="d-block">
                                          Campo experimental — 07 Oct 2025 - 08:05 AM
                                       </small>
                                       <small className="text-info">Valor: 3.2 mg/L</small>
                                    </div>
                                 </div>
                              </li>
                              ...
                              <li>
                                 <div className="timeline-panel">
                                    ...
                                    <div className="media-body">
                                       <h6 className="mb-1">Condiciones estables 🌿</h6>
                                       <small className="d-block">
                                          Sistema funcionando correctamente
                                       </small>
                                       <small className="text-success">Última lectura: 07 Oct 2025 - 08:00 AM</small>
                                    </div>
                                 </div>
                              </li>
                           </ul>
                     ...
                     <Dropdown as="li" className={`nav-item header-profile `}>
                        <Dropdown.Toggle className="nav-link i-false" as="a" >
                           ...
                           <div className="header-info">
                              <span>
                                 Hello,<strong> {user?.nombre || 'Usuario'}</strong>
                              </span>
                           </div>
                        </Dropdown.Toggle>
